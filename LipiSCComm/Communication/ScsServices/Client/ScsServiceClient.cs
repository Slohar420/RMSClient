...
using Lipi.Communication.ScsServices.Communication;
using Lipi.Communication.ScsServices.Communication.Messages;
using System.IO;

namespace Lipi.Communication.ScsServices.Client
{
    /// <summary>
